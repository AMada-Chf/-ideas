...
################################# MISSING MAP ###################################################################
#missing_mapping_df = Crime2_df[Crime2_df['Crime Category'].isnull()] # restituisce un nuovo df con le righe in cui Crime category ha valore nullo 

# Visualizzare le righe filtrate per vedere i valori di "Crm Cd 1" che non sono stati mappati
#print(missing_mapping_df[['Crm Cd 1', 'Crm Cd Desc']])
